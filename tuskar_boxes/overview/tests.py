...
class BoxesViewsTests(helpers.BaseAdminViewTests):
    def test_index_edit_get(self):
        with tests._mock_plan(), \
                mock.patch('tuskar_ui.api.heat.Stack.list',
                           return_value=[]), \
                mock.patch('tuskar_ui.api.node.Node.list',
                           return_value=[]), \
                mock.patch('tuskar_ui.api.flavor.Flavor.list',
                           return_value=[]):
